...
const useOAuth2 = (props) => {
  ...
  const getAuth = useCallback(() => {
      ...
      popupRef.current = openPopup(
        enhanceAuthorizeUrl("https://accounts.google.com/o/oauth2/auth", "922003399486-vepjbjeq9v4dricp2nr9tbetsqkhj20r.apps.googleusercontent.com","http://localhost:3000", scope, state)
      );
  })
}